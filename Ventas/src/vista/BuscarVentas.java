 ...
 */
public class BuscarVentas extends javax.swing.JDialog {

    /**
     * Creates new form AgregarProducto
     */
    public BuscarVentas(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tbVentas.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        tbVentas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NUM VENTA", "FECHA", "HORA", "CLIENTE", "TIPO PAGO", "TOTAL"
            }
        ) {
        ...
        lblBuscar.setText("Buscar una venta");

        txtBuscarVenta.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        tbDetalles.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "PRODUCTO", "CANTIDAD", "VALOR UNITARIO", "SUBTOTAL"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtBuscarVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarVentas dialog = new BuscarVentas(new javax.swing.JFrame(), true);
